...
library(lubridate) # date wrangling. will probably need to separate out counts by month or weeknumber to make visualization easier/nicer
...
# also, dates are sorted by month/date/year numerically. Not chronologically.
