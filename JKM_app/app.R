...
#         tabsetPanel(
   ...
   tabPanel("Time and Species Count Data",
            ...
            )), # this tab panel is self-contained
...
tabPanel("Time and Wrack Data", # JKM removed a close-parenthesis from between ". 
         ...
         ), # JKM added a close-parenthesis here. fingers-crossed. deleted a comma. #changed it back
...
sidebarLayout(
  ...
  mainPanel(
    plotOutput("distPlot")
  ))))) # JKM deleted a comma here #added 2 close-parens.  # this tab panel is self contained
